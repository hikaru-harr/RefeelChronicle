...
export const createUploadPreSignedUrlUsecase = async ({fileName, fileType, userId, now = new Date()}: CreateUploadPreSignedUrlInput): Promise<CreateUploadPreSignedUrlResult> => {
