...
import { type CreateFileProps, createFile, setFilePreviewObjectKey } from "../repository/fileRepository";
...
export const compleatUploadUsecase = async (
	...
	const kind = props.mime.startsWith("image/") ? "image" : props.mime.startsWith("video/") ? "video" : "other";
